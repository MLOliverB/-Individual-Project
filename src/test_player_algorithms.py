...
def run_tests(i):
    if i == 1:
        test_players(RandomPlayer(), RandomPlayer(), save_dir, "random_random.txt", num_test=100)


    elif i == 2:
        test_players(RandomPlayer(), AlphaBetaPlayer(search_depth=1), save_dir, "random_alphabeta-sd1.txt", num_test=100)
    elif i == 3:
        test_players(RandomPlayer(), AlphaBetaPlayer(search_depth=2), save_dir, "random_alphabeta-sd2.txt", num_test=100)
    elif i == 4:
        test_players(RandomPlayer(), AlphaBetaPlayer(search_depth=3), save_dir, "random_alphabeta-sd3.txt", num_test=100)
        ...
        test_players(RandomPlayer(), plr, save_dir, "random_train-1-model-365-sd1-b10.txt", num_test=100)
    elif i == 6:
        model, device = load_model(res_dir + "NN_RL/reward-train-1/model_365.ptm")
        ...
        test_players(RandomPlayer(), plr, save_dir, "random_train-1-model-365-sd2-b10.txt", num_test=100)
    elif i == 7:
        model, device = load_model(res_dir + "NN_RL/reward-train-1/model_365.ptm")
        ...
        test_players(RandomPlayer(), plr, save_dir, "random_train-1-model-365-sd3-b10.txt", num_test=100)
        ...
        test_players(RandomPlayer(), plr, save_dir, "random_train-2-model-206-sd1-b10.txt", num_test=100)
    elif i == 9:
        model, device = load_model(res_dir + "NN_RL/reward-train-2/model_206.ptm")
        ...
        test_players(RandomPlayer(), plr, save_dir, "random_train-2-model-206-sd2-b10.txt", num_test=100)
    elif i == 10:
        model, device = load_model(res_dir + "NN_RL/reward-train-2/model_206.ptm")
        ...
        test_players(RandomPlayer(), plr, save_dir, "random_train-2-model-206-sd3-b10.txt", num_test=100)
        ...
        test_players(RandomPlayer(), plr, save_dir, "random_train-3-model-163-sd1-b10.txt", num_test=100)
    elif i == 12:
        model, device = load_model(res_dir + "NN_RL/reward-train-3/model_163.ptm")
        ...
        test_players(RandomPlayer(), plr, save_dir, "random_train-3-model-163-sd2-b10.txt", num_test=100)
    elif i == 13:
        model, device = load_model(res_dir + "NN_RL/reward-train-3/model_163.ptm")
        ...
        test_players(RandomPlayer(), plr, save_dir, "random_train-3-model-163-sd3-b10.txt", num_test=100)


    elif i == 14:
        test_players(RandomPlayer(), AlphaBetaPlayer(search_depth=1, play_to_lose=True), save_dir, "random_alphabeta-sd1-lose.txt", num_test=100)
    elif i == 15:
        test_players(RandomPlayer(), AlphaBetaPlayer(search_depth=2, play_to_lose=True), save_dir, "random_alphabeta-sd2-lose.txt", num_test=100)
    elif i == 16:
        test_players(RandomPlayer(), AlphaBetaPlayer(search_depth=3, play_to_lose=True), save_dir, "random_alphabeta-sd3-lose.txt", num_test=100)
